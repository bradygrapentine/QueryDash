...
{
    // All of these routes will be at the base URL:     /api/DashQuery
    // That is what "api/[controller]" means below. It uses the name of the controller
    // in this case DashQueryController to determine the URL
    [Route("api/[controller]")]
    [ApiController]
    public class DashQueryController : ControllerBase
    {
        ...
        public DashQueryController(DatabaseContext context)
        {
            _context = context;
        }
        ...
        // GET: api/DashQuery
        //
        // Returns a list of all your DashQueryTable
        //
        [HttpGet]
        public async Task<ActionResult<IEnumerable<DashQuery>>> GetDashQueryTable()
        {
            // Uses the database context in `_context` to request all of the DashQueryTable, sort
            // them by row id and return them as a JSON array.
            return await _context.DashQueryTable.OrderBy(row => row.Id).ToListAsync();
        }
        ...
        public async Task<ActionResult<DashQuery>> GetDashQuery(int id)
        {
            ...
            var dashQuery = await _context.DashQueryTable.FindAsync(id);
        ...
        public async Task<ActionResult<DashQuery>> PostDashQuery(DashQuery dashQuery)
        {
            ...
            _context.DashQueryTable.Add(dashQuery);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteDashQuery(int id)
        {
            ...
            _context.DashQueryTable.Remove(dashQuery);
        ...
        {
            return _context.DashQueryTable.Any(dashQuery => dashQuery.Id == id);
        }
    }
}
